...
/**
 * Parseur/serialiseur JSON minimal, sans dependance externe.
 * Supporte : Map<String,Object>, List<Object>, String, Double, Boolean, null.
 */
public final class Json {
    ...
    private static class Parser {
        ...
        char peek() {
            if (pos >= s.length()) throw new RuntimeException("Fin inattendue du JSON");
            return s.charAt(pos);
        }
        ...
        Map<String, Object> parseObject() {
            ...
            while (true) {
                ...
                skipWhitespace();
                if (peek() != ':') throw new RuntimeException("Attendu ':' en position " + pos);
                pos++;
                ...
                if (c == ',') { pos++; continue; }
                if (c == '}') { pos++; break; }
                throw new RuntimeException("Attendu ',' ou '}' en position " + pos);
            }
            return map;
        }
                ...
                if (c == '\\') {
                    ...
                    switch (esc) {
                        ...
                        case 'u':
                            ...
                            pos += 4;
                            break;
                        default: throw new RuntimeException("Echappement invalide en position " + pos);
                    }
                } else {
                    sb.append(c);
                }
        ...
        Boolean parseBoolean() {
            ...
            throw new RuntimeException("Booleen invalide en position " + pos);
        }

        Object parseNull() {
            if (s.startsWith("null", pos)) { pos += 4; return null; }
            throw new RuntimeException("Null invalide en position " + pos);
        }
